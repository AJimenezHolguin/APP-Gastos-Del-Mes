...
const FormularioGasto = ({gasto}) => {
    ...
    const [inputaCantidad, cambiarInputCantidad] = useState('');
    ...
    useEffect(()=>{
        ...
        // De ser asi establecemos todo el state de los valores del gasto
       if(gasto){
    ...
    const handleSubmit = (e) => {
        ...
        let cantidad = parseFloat(inputaCantidad).toFixed(2);

        // comprobamos que haya una descripción y valor
        if(inputDescripcion !== '' && inputaCantidad !== ''){
            if(cantidad){
                if(gasto){
                    editarGasto({
                        id: gasto.id,
                    ...
                    .then(()=>{
                        ...
                        cambiarAlerta({tipo: 'exito', mensaje: 'El gasto se registro correctamente.'});
                    })
    
                    .catch((error)=>{
                        cambiarEstadoAlerta(true);
                        cambiarAlerta({tipo: 'error', mensaje: 'Hubo un problema al ingresar tu gasto registralo nuevamente.'});
                    })
                }
